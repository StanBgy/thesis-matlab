function varargout = cvnlookup(FSID,view_number,data,clim0,cmap0,thresh0,overlay0,Lookup,wantfig,extraopts,surfsuffix)
...
if ~exist('overlay0','var') ||isempty(overlay0)
    overlay0 = [];
end
...
[rawimg,Lookup,rgbimg] = cvnlookupimages(FSID,valstruct,viewhemis,viewpt,Lookup,...
                ...
                'clim',clim0,'colormap',cmap0,'threshold', thresh0,'overlayalpha',overlay0,extraopts{:});
